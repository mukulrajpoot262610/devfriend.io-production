...
export const CreateProfile = async (req, res) => {
    const { about, collegeYear, facebook, github, headline, instagram, linkedin, name, projectDescription, projectImage1, projectLink, projectName, skill, stack, twitter, website } = req.body;
